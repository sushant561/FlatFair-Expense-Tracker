...
export const FooterSection = (): JSX.Element => {
  return (
    <footer className="flex flex-col w-full items-start justify-center px-20 py-0 relative bg-white">
      <div className="flex items-center gap-12 pt-12 pb-6 px-0 relative self-stretch w-full">
        <div className="relative flex-1 font-body-m font-[number:var(--body-m-font-weight)] text-blue-gray600 text-[length:var(--body-m-font-size)] tracking-[var(--body-m-letter-spacing)] leading-[var(--body-m-line-height)] [font-style:var(--body-m-font-style)]">
      ...
      <div className="flex items-start gap-2.5 pt-6 pb-12 px-0 relative self-stretch w-full">
        <p className="relative flex-1 mt-[-1.00px] font-body-XS font-[number:var(--body-XS-font-weight)] text-blue-gray600 text-[length:var(--body-XS-font-size)] tracking-[var(--body-XS-letter-spacing)] leading-[var(--body-XS-line-height)] [font-style:var(--body-XS-font-style)]">
