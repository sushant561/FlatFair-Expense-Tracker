    ...
    <section className="flex items-center gap-12 pl-20 pr-12 pt-20 pb-12 relative w-full bg-rose-900 min-h-screen overflow-hidden">
      <div className="flex flex-col items-start justify-center gap-6 relative flex-1 self-stretch max-w-[50%]">
        <div className="flex flex-col items-start gap-6 relative self-stretch w-full">
          ...
          <p className="relative self-stretch font-body-l font-[number:var(--body-l-font-weight)] text-white text-[length:var(--body-l-font-size)] tracking-[var(--body-l-letter-spacing)] leading-[var(--body-l-line-height)] [font-style:var(--body-l-font-style)]">
          ...
          <div className="inline-flex items-center gap-4 relative">
            <Button
              className="inline-flex items-center justify-center p-3 bg-blue-600 rounded-lg border-2 border-solid border-[#2563eb]"
              variant="default"
            >
