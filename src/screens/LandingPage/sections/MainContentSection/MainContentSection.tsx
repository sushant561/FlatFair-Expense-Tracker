      ...
      <div className="flex flex-col items-start justify-center gap-6 relative flex-1 self-stretch w-full md:max-w-[50%] px-6 md:px-0 order-2 md:order-1 pb-12 md:pb-0">
        <div className="flex flex-col items-start gap-6 relative self-stretch w-full">
          <div className="flex flex-col items-start gap-2 relative self-stretch w-full">
            <h4 className="relative self-stretch mt-[-1.00px] font-heading-1-m font-[number:var(--heading-1-m-font-weight)] text-white text-[length:var(--heading-1-m-font-size)] tracking-[var(--heading-1-m-letter-spacing)] leading-[1.4] md:leading-[var(--heading-1-m-line-height)] [font-style:var(--heading-1-m-font-style)] text-sm md:text-5xl font-bold">
